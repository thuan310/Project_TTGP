...
public class AIDurkCharacterManager : AIBossCharacterManager
{
    ...
    // and to reference this new sfx manager, and to keep our design pattern the same, we need a durk character manager to reference it from
     ...
     public AINgoQuyenSoundFXManager durkSoundFXManager;
    [HideInInspector] public AINgoQuyenCombatManager durkCombatManager;
    protected override void Awake()
    {
        base.Awake();

        durkSoundFXManager = GetComponent<AINgoQuyenSoundFXManager>();
        durkCombatManager = GetComponent<AINgoQuyenCombatManager>();
    }
}
